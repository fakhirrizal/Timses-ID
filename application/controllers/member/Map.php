...
class Map extends CI_Controller {
	...
	public function province()
	{
		...
		$this->load->view('member/master/map/province',$data);
			...
			$isi['action'] =	'
								<div class="btn-group">
									...
									<ul class="dropdown-menu" role="menu">
										<li>
											<a href="'.site_url('member_side/ubah_data_provinsi/'.md5($value->id_provinsi)).'">
												<i class="icon-wrench"></i> Ubah Data </a>
										</li>
										<li>
											<a onclick="'.$return_on_click.'" href="'.site_url('member_side/hapus_data_provinsi/'.md5($value->id_provinsi)).'">
	...
	public function add_province()
	{
		...
		$data['grand_child'] = 'province';
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/add_province',$data);
		$this->load->view('member/template/footer');
	}
	public function save_province(){
		...
		if($this->db->trans_status() === false){
			...
			echo "<script>window.location='".base_url()."member_side/tambah_data_provinsi'</script>";
		}
		else{
			...
			echo "<script>window.location='".base_url()."member_side/data_provinsi/'</script>";
		}
	}
	public function edit_province()
	{
		...
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/edit_province',$data);
		$this->load->view('member/template/footer');
	}
	public function update_province_data(){
		...
		if($this->db->trans_status() === false){
			...
			echo "<script>window.location='".base_url()."member_side/ubah_data_provinsi/".$this->input->post('id_provinsi')."'</script>";
		}
		else{
	...
	public function city()
	{
		...
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/city',$data);
		$this->load->view('member/template/footer');
	}
		...
		foreach ($get_data as $key => $value) {
			...
			$isi['action'] =	'
								<div class="btn-group">
									...
									<ul class="dropdown-menu" role="menu">
										<li>
											<a href="'.site_url('member_side/ubah_data_kabkot/'.md5($value->id_kabupaten)).'">
												<i class="icon-wrench"></i> Ubah Data </a>
										</li>
										<li>
											<a onclick="'.$return_on_click.'" href="'.site_url('member_side/hapus_data_kabkot/'.md5($value->id_kabupaten)).'">
												<i class="icon-trash"></i> Hapus Data </a>
										</li>
									</ul>
								</div>
	...
	public function add_city()
	{
		...
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/add_city',$data);
		$this->load->view('member/template/footer');
	}
	public function save_city(){
		...
		if($this->db->trans_status() === false){
			$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal disimpan.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/tambah_data_kabkot'</script>";
		}
		else{
			$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil disimpan.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/data_kabkot/'</script>";
		}
	}
	public function edit_city()
	{
		...
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/edit_city',$data);
		$this->load->view('member/template/footer');
	}
	public function update_city_data(){
		...
		if($this->db->trans_status() === false){
			$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/ubah_data_kabkot/".$this->input->post('id_kabupaten')."'</script>";
		}
		else{
			$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/data_kabkot/'</script>";
	...
	public function sub_district()
	{
		...
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/sub_district',$data);
		$this->load->view('member/template/footer');
	}
		...
		foreach ($get_data as $key => $value) {
			...
			$isi['action'] =	'
								<div class="btn-group">
									...
									<ul class="dropdown-menu" role="menu">
										<li>
											<a href="'.site_url('member_side/ubah_data_kecamatan/'.md5($value->id_kecamatan)).'">
												<i class="icon-wrench"></i> Ubah Data </a>
										</li>
										<li>
											<a onclick="'.$return_on_click.'" href="'.site_url('member_side/hapus_data_kecamatan/'.md5($value->id_kecamatan)).'">
												<i class="icon-trash"></i> Hapus Data </a>
										</li>
									</ul>
								</div>
	...
	public function add_sub_district()
	{
		...
		$data['provinsi'] = $this->Main_model->getSelectedData('provinsi a', 'a.*')->result();
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/add_sub_district',$data);
		$this->load->view('member/template/footer');
	}
	public function save_sub_district(){
		...
		if($this->db->trans_status() === false){
			$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal disimpan.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/tambah_data_kecamatan'</script>";
		}
		else{
			$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil disimpan.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/data_kecamatan/'</script>";
		}
	}
	public function edit_sub_district()
	{
		...
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/edit_sub_district',$data);
		$this->load->view('member/template/footer');
	}
	public function update_sub_district_data(){
		...
		if($this->db->trans_status() === false){
			$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/ubah_data_kecamatan/".$this->input->post('id_kecamatan')."'</script>";
		}
		else{
			$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/data_kecamatan/'</script>";
	...
	public function village()
	{
		...
		$data['data_marker'] = $this->Main_model->getSelectedData('desa a', 'a.*',array('md5(a.id_kecamatan)'=>$this->uri->segment(3)))->result();
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/village',$data);
		$this->load->view('member/template/footer');
	}
	public function json_peta_kelurahan(){
		...
		$action =	'<div class="btn-group">
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="'.site_url('member_side/ubah_data_kelurahan/$1').'">
									<i class="icon-wrench"></i> Ubah Data </a>
							</li>
							<li>
								<a onclick="'.$return_on_click.'" href="'.site_url('member_side/hapus_data_kelurahan/$1').'">
									<i class="icon-trash"></i> Hapus Data </a>
							</li>
						</ul>
					</div>';
	...
	public function add_village()
	{
		...
		$data['provinsi'] = $this->Main_model->getSelectedData('provinsi a', 'a.*')->result();
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/add_village',$data);
		$this->load->view('member/template/footer');
	}
	public function save_village(){
		...
		if($this->db->trans_status() === false){
			$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal disimpan.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/tambah_data_kelurahan'</script>";
		}
		else{
			$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil disimpan.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/data_kelurahan/'</script>";
		}
	}
	public function edit_village()
	{
		...
		$this->load->view('member/template/header',$data);
		$this->load->view('member/master/map/edit_village',$data);
		$this->load->view('member/template/footer');
	}
	public function update_village_data(){
		...
		if($this->db->trans_status() === false){
			$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/ubah_data_kelurahan/".$this->input->post('id_desa')."'</script>";
		}
		else{
			$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."member_side/data_kelurahan/'</script>";
