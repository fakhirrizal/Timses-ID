...
class App extends CI_Controller {
	...
	public function launcher()
	{
		...
		$this->load->view('relawan/app/launcher');
    ...
    public function home()
	{
		...
		$this->load->view('relawan/template/header',$data);
		$this->load->view('relawan/app/home',$data);
		$this->load->view('relawan/template/footer');
	}
	public function log_activity()
	{
		...
		$this->load->view('relawan/template/header',$data);
		$this->load->view('relawan/app/log_activity',$data);
		$this->load->view('relawan/template/footer');
	}
	public function hapus_aktifitas(){
		...
		if($this->db->trans_status() === false){
			...
			echo "<script>window.location='".base_url()."relawan_side/log_activity/'</script>";
		}
		else{
	...
	public function about()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('relawan/template/header',$data);
		$this->load->view('relawan/app/about',$data);
		$this->load->view('relawan/template/footer');
	}
	public function helper()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('relawan/template/header',$data);
		$this->load->view('relawan/app/helper',$data);
		$this->load->view('relawan/template/footer');
	}
	...
	public function ajax_function(){
		if($this->input->post('modul')=='modul_detail_log_aktifitas'){
			...
			$this->load->view('relawan/app/ajax_detail_log_aktifitas',$data);
		}
	}
}