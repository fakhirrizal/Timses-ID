										...
										<tbody>
											...
											foreach ($data_all as $key => $value) {
												...
												<tr>
													...
													<td><a href="'.site_url().'relawan_side/dasbor_grafik_kabupaten/'.md5($value->id_kabupaten).'">'.$value->nm_kabupaten.'</a></td>
													...
													<td style="text-align: center;">
														<a class="btn btn-xs green" href="'.site_url().'relawan_side/dasbor_grafik_kabupaten/'.md5($value->id_kabupaten).'">
