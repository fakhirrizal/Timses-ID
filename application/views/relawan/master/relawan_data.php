...
<div class="page-content-inner">
	<div class="m-heading-1 border-green m-bordered">
		<h3>Catatan</h3>
		<p>1. Data yang Akan muncul adalah data Relawan yang tercakup kedalam wilayah Anda</p>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-body">
					<div class="table-toolbar">
						<div class="row">
							<div class="col-md-8">
								<a href="<?= site_url('relawan_side/tambah_data_relawan/'); ?>" class="btn green uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
							</div>
						</div>
					</div>
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							$('#tbl').dataTable({
								...
								"bProcessing": true,
								"ajax" : {
									url:"<?= site_url('relawan/Master/json_relawan_data'); ?>"
								},
								"aoColumns": [
