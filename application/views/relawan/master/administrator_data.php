						...
						<div class="row">
							<div class="col-md-6">
								<div class="btn-group">
									...
									<a href="<?=base_url('relawan_side/tambah_data_admin');?>" class="btn green uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
								...
								<td>
									<div class="btn-group" style="text-align: center;">
										...
										<ul class="dropdown-menu" role="menu">
											<li>
												<a href="<?=site_url('relawan_side/detail_data_admin/');?>">
													<i class="icon-eye"></i> Detail Data </a>
											</li>
											<li>
												<a href="<?=site_url('relawan_side/ubah_data_admin/');?>">
													<i class="icon-wrench"></i> Ubah Data </a>
											</li>
											<li>
												<a onclick="return confirm('Anda yakin?')" href="<?=site_url('relawan_side/hapus_data_admin/');?>">
													<i class="icon-trash"></i> Hapus Data </a>
											</li>
											<li class="divider"> </li>
											<li>
												<a href="<?=site_url('relawan_side/atur_ulang_kata_sandi_admin/');?>">
