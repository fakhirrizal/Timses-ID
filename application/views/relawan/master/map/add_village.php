...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<span><a href='<?= site_url('/relawan_side/data_kelurahan'); ?>'>Data Kelurahan/ Desa</a></span>
		<i class="fa fa-circle"></i>
	</li>
	<li>
...
<div class="page-content-inner">
	<div class="m-heading-1 border-green m-bordered">
		...
		<p> 2. Untuk marker disini merupakan titik ibu kota dari suatu Kecamatan</p>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-body">
					<form role="form" class="form-horizontal" action="<?=base_url('relawan_side/simpan_data_kelurahan');?>" method="post"  enctype='multipart/form-data'>
						<div class="form-body">
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="nm_desa" placeholder="Type something" required>
