					...
					<div class="hor-menu  ">
						<ul class="nav navbar-nav">
							...
							<!-- <li class="menu-dropdown classic-menu-dropdown <?php if($parent=='dashboard'){echo 'active';}else{echo '';} ?>">
								<a href="<?php echo site_url('member_side/dasbor'); ?>"><i class="icon-frame"></i> Dashboard
								</a>
							</li> -->
							<li class="menu-dropdown classic-menu-dropdown <?php if($parent=='master'){echo 'active';}else{echo '';} ?>">
								...
								<ul class="dropdown-menu pull-left">
									<!-- <li class=" <?php if($child=='saksi'){echo 'active';}else{echo '';} ?>">
										<a href="<?php echo site_url('member_side/data_saksi'); ?>" class="nav-link nav-toggle ">
											<i class="icon-user-following"></i> Data Saksi
										</a>
									</li> -->
									...
									<!-- <li class=" <?php if($child=='target_suara'){echo 'active';}else{echo '';} ?>">
										<a href="<?php echo site_url('member_side/target_suara'); ?>" class="nav-link nav-toggle ">
											<i class="icon-layers"></i> Target Suara
										</a>
									</li> -->
								</ul>
							</li>
							<li class="menu-dropdown classic-menu-dropdown <?php if($parent=='command_center'){echo 'active';}else{echo '';} ?>">
								...
								<ul class="dropdown-menu pull-left">
									...
									<!-- <li class=" <?php if($child=='report'){echo 'active';}else{echo '';} ?>">
										<a href="<?php echo site_url('member_side/rekap_laporan'); ?>" class="nav-link nav-toggle ">
