...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<span><a href='<?= site_url('/member_side/data_kelurahan'); ?>'>Data Kelurahan/ Desa</a></span>
		<i class="fa fa-circle"></i>
	</li>
	<li>
		...
		<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-body">
					<form role="form" class="form-horizontal" action="<?=base_url('member_side/simpan_data_kelurahan');?>" method="post"  enctype='multipart/form-data'>
						<div class="form-body">
